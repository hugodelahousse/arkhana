    ...
    <main className="max-w-2xl mx-auto px-6 py-12 sm:py-20 space-y-14 text-center">
      <JsonLd
        data={{
          ...
          url: `${origin}/`,
          description:
            "Draw one tarot card every day and build your personal arkhive. 78 beautifully illustrated cards with unique readings across five rarity tiers.",
        }}
      />
      ...
      <header className="space-y-5">
        ...
        <p className="type-body-serif text-muted-foreground max-w-md mx-auto">
          Draw one card each day and build your personal arkhive. Seventy-eight
          beautifully illustrated tarot cards, each with its own reading across
          five rarity tiers.
        </p>
      ...
      <section className="space-y-4 max-w-md mx-auto">
        ...
        <ul className="type-body-serif space-y-2 text-left text-muted-foreground">
          ...
          <li>
            78 cards across the Major and Minor Arcana, every one fully
            illustrated.
          </li>
          <li>
